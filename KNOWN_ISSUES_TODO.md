# KNOWN ISSUES & ROADMAP — Beta v0.6.32

> 研发进度表与技术债记录。更新于 2026-05-13。
> 涵盖 v0.5.4 → v0.6.32 共 **多轮深度审计** 的完整 Epic 记录。

---

## ✅ Beta v0.6.x — Release 记录

| 版本 | 日期 | 核心成果 |
|:---|:---:|:---|
| v0.6.32 | 05-13 | 50次迭代优化：DB Writer健康监控、WebSocket竞态修复、LRU缓存、智能轮询、数据新鲜度、类型安全、请求取消 |
| v0.6.29 | 05-12 | Walk-Forward分析增强：智能参数推荐、快速预设、异常检测；移除MCP配置（Mock实现） |
| v0.6.28 | 05-11 | 版本发布与文档更新 |
| v0.6.27 | 05-11 | 修复ETF数据兼容性、指标图表初始加载 |
