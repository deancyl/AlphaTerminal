# KNOWN ISSUES & ROADMAP — Beta v0.5.117

> 研发进度表与技术债记录。更新于 2026-04-19。
> 涵盖 v0.5.4 → v0.5.117 共 **141 次提交**的完整 Epic 记录。
...
| 版本 | 日期 | 核心成果 |
|:---|:---:|:---|
| v0.5.117 | 04-19 | 回测看板股票/组合双模式 + PortfolioStore reactive 链路修复 + symbol 前缀自动推断 |
