...
# ── 轮询标的（扩大覆盖：核心指数 + 主要个股，确保 150+ 条新闻池）──────────
NEWS_SYMBOLS = [
    # 核心指数
    "000001", "399001", "399006", "000300", "000016",
    # 银行
    "600036", "601318", "600000", "601166", "600016",
    # 保险/券商
    "601628", "600030", "601688", "000776",
    # 科技/新能源
    "600585", "002594", "300750", "688981",
    # 消费
    "600519", "000858", "603288", "600887",
    # 周期
    "601899", "600028", "600050", "601888",
    # 更多中小盘
    "002230", "300059", "688111", "300760",
    "002475", "300015", "002352", "300122",
    "600009", "600031", "002601", "300274",
    "601012", "600150", "601668", "600276",
]
...
def fetch_latest_news(limit: int = 150) -> list[dict]:
    ...
    for sym in NEWS_SYMBOLS:
        ...
        time.sleep(0.15)   # 礼貌性延迟，避免触发东财频率限制
