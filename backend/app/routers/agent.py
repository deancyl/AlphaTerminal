...
async def create_strategy(
    ...
    try:
        ...
        logger.debug("[AGENT_STRATEGY_CREATE] Validating strategy code")
        ...
        logger.debug("[AGENT_STRATEGY_CREATE] Creating strategy in database")
...
async def update_strategy(
    ...
    try:
        ...
        logger.debug("[AGENT_STRATEGY_UPDATE] Updating strategy in database")
