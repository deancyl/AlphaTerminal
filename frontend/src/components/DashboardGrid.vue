  ...
  <div v-if="isMobile" class="flex flex-col gap-3 px-3 py-3 overflow-y-auto min-w-0" style="height: 100dvh; padding-bottom: 80px;">
    ...
    <div class="flex gap-3 overflow-x-auto pb-2 scrollbar-hide shrink-0">
      <button v-for="anchor in mobileAnchors" :key="anchor.id"
        :href="`#${anchor.id}`"
        class="shrink-0 px-2 py-1 rounded-full text-xs transition-colors h-7 flex items-center"
        :class="'bg-terminal-accent/10 text-terminal-accent hover:bg-terminal-accent/20'"
