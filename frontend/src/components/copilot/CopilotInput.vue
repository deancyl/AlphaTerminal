    ...
    <div class="relative">
      ...
      <button
        ...
        :class="isLoading || !inputText.trim()
          ...
          : 'bg-terminal-accent/20 text-agent-blue hover:bg-agent-blue/30 ring-2 ring-agent-blue ring-offset-2 ring-offset-terminal-bg shadow-lg shadow-agent-blue/30 hover:shadow-agent-blue/50 animate-pulse'"
