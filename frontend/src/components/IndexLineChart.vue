  ...
  <div class="w-full h-full min-h-[120px] relative flex flex-col">
    ...
    <div class="shrink-0 flex flex-col border-b border-theme bg-theme/60">
      <div class="px-2 py-1 flex items-center justify-between">
        ...
        <!-- 移动端全屏按钮 -->
        <button
          class="md:hidden ml-auto mr-1 px-2 h-8 text-xs rounded-sm border border-terminal-accent/30 text-terminal-accent hover:bg-terminal-accent/10 transition-colors flex items-center"
          title="横屏全屏"
