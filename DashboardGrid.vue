  ...
  <div class="grid-stack" ref="gridRef">
    ...
    <div class="grid-stack-item"
      ...
      <div class="grid-stack-item-content terminal-panel p-3">
        ...
        <!-- 数据行：flex flex-col justify-between 均匀填满卡片 -->
        <div class="flex flex-col justify-between flex-1 overflow-hidden">
          <div
            v-for="item in windItems" :key="item.symbol"
            class="grid grid-cols-3 gap-0 items-center border-b border-gray-800/50 hover:bg-white/5 cursor-pointer transition-colors text-[11px] font-mono py-1"
